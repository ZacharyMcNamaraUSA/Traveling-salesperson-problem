...
def main():
    ...
    g.add_undirected_edge(vertex_8, vertex_9, 7.2)
    g.add_undirected_edge(vertex_8, vertex_10, 3.8)
    g.add_undirected_edge(vertex_8, vertex_11, 11.0)
    g.add_undirected_edge(vertex_8, vertex_12, 2.2)
    g.add_undirected_edge(vertex_8, vertex_13, 3.5)
    g.add_undirected_edge(vertex_8, vertex_14, 10.9)
    g.add_undirected_edge(vertex_8, vertex_15, 8.6)
    g.add_undirected_edge(vertex_8, vertex_16, 7.6)
    g.add_undirected_edge(vertex_8, vertex_17, 2.8)
    g.add_undirected_edge(vertex_8, vertex_18, 6.4)
    g.add_undirected_edge(vertex_8, vertex_19, 3.2)
    g.add_undirected_edge(vertex_8, vertex_20, 7.6)
    g.add_undirected_edge(vertex_8, vertex_21, 5.2)
    g.add_undirected_edge(vertex_8, vertex_22, 4.4)
    g.add_undirected_edge(vertex_8, vertex_23, 3.7)
    g.add_undirected_edge(vertex_8, vertex_24, 7.6)
    g.add_undirected_edge(vertex_8, vertex_25, 2.0)
    g.add_undirected_edge(vertex_8, vertex_26, 3.6)
    g.add_undirected_edge(vertex_8, vertex_27, 6.5)
    g.add_undirected_edge(vertex_8, vertex_28, 1.9)
    g.add_undirected_edge(vertex_8, vertex_29, 3.4)
    g.add_undirected_edge(vertex_8, vertex_30, 2.4)
    g.add_undirected_edge(vertex_8, vertex_31, 6.4)
    g.add_undirected_edge(vertex_8, vertex_32, 2.4)
    g.add_undirected_edge(vertex_8, vertex_33, 5.0)
    g.add_undirected_edge(vertex_8, vertex_34, 3.6)

    g.add_undirected_edge(vertex_10, vertex_9, 7.1)
    g.add_undirected_edge(vertex_10, vertex_11, 9.2)

    g.add_undirected_edge(vertex_12, vertex_9, 6.0)
    g.add_undirected_edge(vertex_12, vertex_10, 4.4)
    g.add_undirected_edge(vertex_12, vertex_11, 5.6,)

    g.add_undirected_edge(vertex_13, vertex_9, 3.5)
    g.add_undirected_edge(vertex_13, vertex_10, 2.8)
    g.add_undirected_edge(vertex_13, vertex_11, 6.9)
    g.add_undirected_edge(vertex_13, vertex_12, 1.9)

    g.add_undirected_edge(vertex_14, vertex_9, 1.6)
    g.add_undirected_edge(vertex_14, vertex_10, 8.6)
    g.add_undirected_edge(vertex_14, vertex_11, 8.6)
    g.add_undirected_edge(vertex_14, vertex_12, 7.9)
    g.add_undirected_edge(vertex_14, vertex_13, 6.3)

    g.add_undirected_edge(vertex_15, vertex_9, 2.8)
    g.add_undirected_edge(vertex_15, vertex_10, 6.3)
    g.add_undirected_edge(vertex_15, vertex_11, 4.0)
    g.add_undirected_edge(vertex_15, vertex_12, 5.1)
    g.add_undirected_edge(vertex_15, vertex_13, 4.3)
    g.add_undirected_edge(vertex_15, vertex_14, 4.0)

    g.add_undirected_edge(vertex_16, vertex_9, 4.8)
    g.add_undirected_edge(vertex_16, vertex_10, 5.3)
    g.add_undirected_edge(vertex_16, vertex_11, 11.1)
    g.add_undirected_edge(vertex_16, vertex_12, 7.5)
    g.add_undirected_edge(vertex_16, vertex_13, 4.5)
    g.add_undirected_edge(vertex_16, vertex_14, 4.2)
    g.add_undirected_edge(vertex_16, vertex_15, 7.7)

    g.add_undirected_edge(vertex_17, vertex_9, 6.3)
    g.add_undirected_edge(vertex_17, vertex_10, 1.6)
    g.add_undirected_edge(vertex_17, vertex_11, 7.3)
    g.add_undirected_edge(vertex_17, vertex_12, 2.6)
    g.add_undirected_edge(vertex_17, vertex_13, 1.5)
    g.add_undirected_edge(vertex_17, vertex_14, 8.0)
    g.add_undirected_edge(vertex_17, vertex_15, 9.3)
    g.add_undirected_edge(vertex_17, vertex_16, 4.8)

    g.add_undirected_edge(vertex_18, vertex_9, 7.3)
    g.add_undirected_edge(vertex_18, vertex_10, 10.4)
    g.add_undirected_edge(vertex_18, vertex_11, 1.0)
    g.add_undirected_edge(vertex_18, vertex_12, 6.5)
    g.add_undirected_edge(vertex_18, vertex_13, 8.7)
    g.add_undirected_edge(vertex_18, vertex_14, 8.6)
    g.add_undirected_edge(vertex_18, vertex_15, 4.6)
    g.add_undirected_edge(vertex_18, vertex_16, 11.9)
    g.add_undirected_edge(vertex_18, vertex_17, 9.4)

    g.add_undirected_edge(vertex_19, vertex_9, 5.3)
    g.add_undirected_edge(vertex_19, vertex_10, 3.0)
    g.add_undirected_edge(vertex_19, vertex_11, 6.4)
    g.add_undirected_edge(vertex_19, vertex_12, 1.5)
    g.add_undirected_edge(vertex_19, vertex_13, 0.8)
    g.add_undirected_edge(vertex_19, vertex_14, 6.9)
